# using nltk vader  built in lexicon classifier because generating dataset
# for classifier myself would take too long, might create custom dataset
# tho
...
def sentiment_analyzer(sentences):
    ...
    for sentence in sentences:
        sentence_score = sentiment_polarity_analyzer.polarity_scores(sentence)[
            'compound']
